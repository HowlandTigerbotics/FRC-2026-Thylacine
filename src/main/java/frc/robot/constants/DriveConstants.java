...
public class DriveConstants {
    ...
    public final static class Ports {
        // Port Constants (Reason for split is because these go in the subsystem)
        public static final int FL_DRIVE_PORT= 1;
        public static final int FR_DRIVE_PORT = 3;
        public static final int BL_DRIVE_PORT = 8;
        public static final int BR_DRIVE_PORT = 6;

        public static final int FL_ANGLE_PORT = 2;
        public static final int FR_ANGLE_PORT = 4;
